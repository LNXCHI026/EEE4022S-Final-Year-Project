...
/* Signals used */
#define DAC_SIGNAL_CHIRP_LENGTH		8000
#define DAC_SIGNAL_SINUS_LENGTH		8000
 ...
 */
typedef enum {
	TM_DAC_SIGNAL_Signal_Chirp = 0x00,    /*!< Select sinus signal on DAC output */
	TM_DAC_SIGNAL_Signal_Sinus = 0x01, /*!< Select triangle signal on DAC output */
